    ...
    async function fetchLivros() {
      try {
        ...
        const response = await fetch(
          "https://biblioteca-aahcb8aeeegfdwg8.brazilsouth-01.azurewebsites.net/livros",
          {
            headers: {
    ...
    <div className={styles.livrosComFiltroContainer}>
      ...
      <div className={styles.content}>
        <div className={styles.sidebar}>
          ...
          <div className={styles.filtroItens}>
  {autores.map((autor) => (
    <div key={autor} className={styles.filtroItem}>
      <input
        type="checkbox"
...
<div className={styles.filtroItens}>
  {editoras.map((editora) => (
    <div key={editora} className={styles.filtroItem}>
      <input
        type="checkbox"
