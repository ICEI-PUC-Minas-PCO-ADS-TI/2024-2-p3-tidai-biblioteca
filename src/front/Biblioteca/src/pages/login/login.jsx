...
export default function Login({ onLogin }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch("https://localhost:7016/api/Authenticated/login", {
                method: "POST",
                headers: {
            ...
            if (response.ok) {
                ...
                onLogin(tipoUsuario); 
                navigate(tipoUsuario === 'admin' ? "/homeAdmin" : "/biblioteca");
        ...
        <div className={style.main}>
            ...
            <div className={style.right}>
                ...
                <div className={style.buttonsCadastros}>
                    ...
                    <NavLink to="/cadastroAdministrador" className={style.buttonsNavLink}>
                        <button>Administrador</button>
                    </NavLink>
                </div>
            </div>
